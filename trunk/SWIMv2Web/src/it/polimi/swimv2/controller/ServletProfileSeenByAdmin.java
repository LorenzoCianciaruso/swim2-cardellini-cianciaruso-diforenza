...
/**
 * Servlet implementation class ServletProfileSeenByAdmin
 */
public class ServletProfileSeenByAdmin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//receive the id corresponding to the profile to see
				...
				List<AbilitiesDeclared> abilities = abilityDeclaredBean.findAbilitiesOwnedByUserId(id);
				...
				RequestDispatcher rd = sc.getRequestDispatcher("/profileSeenByAdmin.jsp");
